    ...
    <div className={`animate-in fade-in duration-700 ${d.activeTab === 'messaging' ? 'h-full flex flex-col' : 'space-y-8'}`}>
      ...
      {d.activeTab === 'mentees' && (
        <ErrorBoundary><Suspense fallback={<div className="h-64 bg-slate-50 rounded-[32px] animate-pulse" />}><MenteesTab
          ...
          editingGoal={d.editingGoal}
          setEditingGoal={d.setEditingGoal}
          goalInput={d.goalInput}
          setGoalInput={d.setGoalInput}
          handleSaveGoal={d.handleSaveGoal}
          editingStrength={d.editingStrength}
          setEditingStrength={d.setEditingStrength}
          editingFocus={d.editingFocus}
          setEditingFocus={d.setEditingFocus}
          strengthInput={d.strengthInput}
          setStrengthInput={d.setStrengthInput}
          focusInput={d.focusInput}
          setFocusInput={d.setFocusInput}
          handleSaveStrengthFocus={d.handleSaveStrengthFocus}
