      ...
      {recordingState !== 'idle' ? (
        ...
        <>
          ...
          <div className="flex h-[42px] items-center justify-center w-10 text-[#54656f] mb-0.5" >
            {inputText.trim() ? (
              <button onClick={handleSendMessage} className="text-[#54656f] hover:text-[#00a884] transition-colors"><Send size={24} /></button>
            ) : (
              <button onClick={startRecording} className="text-[#54656f] hover:text-[#00a884] transition-colors">
                <svg viewBox="0 0 24 24" width="26" height="26" fill="currentColor">
