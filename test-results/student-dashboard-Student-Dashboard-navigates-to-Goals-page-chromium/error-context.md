...
- Name: student-dashboard.spec.ts >> Student Dashboard >> navigates to Goals page
- Location: e2e\student-dashboard.spec.ts:139:3
...
Call log:
  - waiting for getByRole('link', { name: 'Goals' })
    ...
    - generic [ref=e6]:
      ...
      - generic [ref=e10]:
        - generic [ref=e11]:
          ...
          - paragraph [ref=e14]: WELCOME BACK TO MENTORINO WORKSPACE
        - generic [ref=e15]:
          - generic [ref=e16]:
            - paragraph [ref=e17]: INVITATION ONLY
            - paragraph [ref=e18]: Accounts are created by invitation only. Submit an application first — if approved, you will receive your login credentials.
          - generic [ref=e19]:
            - generic [ref=e20]:
              - text: EMAIL ADDRESS
              - textbox "name@example.com" [ref=e22]
            - generic [ref=e23]:
              - generic [ref=e24]:
                - generic [ref=e25]: PASSWORD
                - button "FORGOT?" [ref=e26]
              - textbox "••••••••" [ref=e28]
            - button "SIGN IN" [ref=e29]
            - link "DON'T HAVE AN ACCOUNT? APPLY HERE" [ref=e31] [cursor=pointer]:
              - /url: "#/apply"
```
